        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text"
                                           ...
                                           class="form-control"
                                           placeholder="لینک پست پلن وارد کنید">
                                    @error('slug')
                                    <p class="text-danger mt-1">{{$message}}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                            <label for="email_address_2">قیمت پلن</label>
                        </div>
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text"
                                           ...
                                           class="form-control"
                                           placeholder="قیمت پلن وارد کنید">
                                    @error('price')
                                    <p class="text-danger mt-1">{{$message}}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div wire:ignore class="select2 input-field col s12">
                                <select wire:model.lazy="parent_id">
                                    ...
                                    @foreach(\App\Models\Price::whereNull('parent_id')->pluck('title','id') as $key => $item)
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                            <label for="email_address_2">ویژگی ها</label>
                        </div>
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <input type="text"
                                   wire:model.lazy="featur"
                                   class="form-control"
                                   placeholder="ویژگی پلن را وارد کنید">
                            <button  wire:click="add_feature" class="btn btn-success">+</button>
                            @foreach($featurs ?? [] as $key => $item)
                                <span class="label bg-blue m-b-10"><i wire:click="remove_feature({{$key}})" class="fa fa-times mx-2"></i>{{$item}}</span>
                            @endforeach
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            ...
                            <button type="button" wire:click="save" class="btn btn-primary m-t-15 waves-effect">ثبت</button>
                        </div>
                    </div>
                    </form>
                </div>
