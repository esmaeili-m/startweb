        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    ...
                    <a href="{{route('price.trash')}}"><button class="btn-hover btn-border-radius color-8 border-radius-custom">سطل آشغال ( {{\App\Models\Price::onlyTrashed()->count()}} )</button></a>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($data ?? [] as $item)
                            <tr data-id="{{$item->id}}" class="sortable-item">
                                ...
                                <td>
                                    <a href="{{route('price.update',$item->id)}}"><button class="btn tblActnBtn">
