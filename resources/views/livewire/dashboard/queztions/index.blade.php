<div>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <a href="{{route('queztions.create')}}"><button class="btn-hover btn-border-radius color-7 border-radius-custom">افزودن سوال</button></a>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($data ?? [] as $item)
                            <tr data-id="{{$item->id}}" class="sortable-item">
                                ...
                                <td>{{$item->title}}</td>
                                <td>
                                    <a href="{{route('queztions.update',$item->id)}}"><button class="btn tblActnBtn">
